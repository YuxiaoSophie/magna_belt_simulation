...
Run:
    uv run python scripts/check_lcm_contract.py
    uv run python scripts/check_lcm_contract.py --device cpu
"""
...
LAYOUTS_PATH = REPO_ROOT / "scripts/data/drake_lcm_layouts.json"
...
def main() -> int:
    ...
    # Build exactly as round_belt_lcm_simulation.py does, but headless / non-realtime.
