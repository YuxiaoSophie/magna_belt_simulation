...
def add_urdf_as_static_shapes(
    ...
    *,
    ...
    VBD entry of the coupled solver can own them, and so no zero-mass articulation ends up
    inside the MuJoCo entry. A link on a continuous/revolute joint to the root becomes a
    body on a world revolute joint carrying that link's shapes.
