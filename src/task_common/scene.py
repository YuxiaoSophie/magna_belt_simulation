...
from task_common.defaults import (
    CABLE_CONTACT_KD,
    CABLE_CONTACT_KE,
    CABLE_CONTACT_MU,
    make_robust_table_collision_cfg,
    make_visual_cfg,
)
...
def make_builder() -> newton.ModelBuilder:
    """Z up, -9.81 gravity, cable material as the default shape material."""
...
def select_gripper_proxy_bodies(builder, first_body_index, end_body_index) -> list[int]:
    """2F-85 bodies proxied into VBD: the pads, else the followers, else any non-silicone pad."""
    body_info = []
...
def build_task_scene(
    ...
    *,
    ...
    pad_bodies = select_gripper_proxy_bodies(
